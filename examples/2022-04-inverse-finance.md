...
**OAK Techniques observed:** **OAK-T9.001** (Oracle Price Manipulation — single-input-feed subclass on the April 2 incident; LP-token-price subclass on the June 16 incident); **OAK-T9.002** (Flash-Loan-Enabled Exploit) as the precondition on both incidents; **OAK-T7.001** (Mixer-Routed Hop — proceeds from the April 2 incident and the June 16 incident were routed through Tornado Cash).
