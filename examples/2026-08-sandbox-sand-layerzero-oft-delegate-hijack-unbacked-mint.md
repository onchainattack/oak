...
- **This is the second LayerZero OFT authority compromise in the 2026 corpus.** The Stake DAO vsdCRV case in May turned on OFT **peer** configuration; this one turns on the OFT **delegate** role. Two incidents, two different configuration roles, one standard — enough to treat OFT configuration authority as a distinct control surface deserving its own review checklist rather than as an implementation detail of each deployment.
