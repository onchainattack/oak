...
**Attribution:** **multi-actor, multi-chain** — The cohort spans independent operators across Ethereum, BSC, Polygon, Avalanche, Solana, Arbitrum, and Base. SafeMoon (BSC) is the largest named case with federal enforcement attribution; the memecoin partial-lock cohort (2024–2025, BSC + Solana) is the highest-volume sub-pattern.
