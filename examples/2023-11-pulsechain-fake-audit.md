...
**Attribution:** **pseudonymous** — the projects' deployer addresses exhibit funder-graph clustering consistent with 3-5 distinct operator clusters. Individual project teams operated under anonymous identities. No named individuals have been publicly attributed at v0.1. CertiK and Hacken each published statements clarifying that the named projects had no audit engagements.
