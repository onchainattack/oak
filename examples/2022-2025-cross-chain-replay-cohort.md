...
**Attribution:** **unattributed** Cross-chain replay is a bridge-architecture vulnerability class, not an operator-attribution class. Individual smaller-scale replay incidents are pseudonymous and not centrally catalogued; the class is characterised in academic bridge-security literature and in audit-firm bridge-architecture reviews.
