...
**Attribution:** **structural / design-level** — no attributed attacker. The builder centralization is a market-structure outcome of MEV-Boost's architecture and the economics of exclusive order flow; specific builders (Titan, Builder0x69/beaverbuild, rsync, Flashbots) are known entities.
