...
**Attribution:** **unattributed** — Dmitry Nedospasov (Wallet.fail), Thomas Roth (leveldown security), and Josh Datko (Cryptotronix) disclosed at 35C3 (35th Chaos Communication Congress) in Leipzig, Germany, December 27, 2018. Coordinated disclosure to vendors prior to public presentation.
