...
**OAK Techniques observed:** **OAK-T11** broadly construed (custodial private-key-storage architectural failure; the operator stored users' raw signing keys server-side rather than implementing non-custodial signing).
