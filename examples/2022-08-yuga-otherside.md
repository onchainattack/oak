...
**Attribution:** **pseudonymous** at the per-incident level. Industry-cohort-graph analysis (PeckShield, ZachXBT) places the cohort within the broader OAK-G02 Drainer-as-a-Service operator-substrate at `inferred-strong` confidence at the cohort level but not at single-actor-of-record per-incident confidence.
