...
**Attribution:** **structural / design-level** — no attacker; the discount is a governance-design outcome rather than an adversarial extraction. Coinbase controls the cbETH contract and the staking infrastructure but does not offer a redemption mechanism.
