...
**Attribution:** **unattributed** The gap is documented in L2BEAT stage-classification analyses, Optimism governance documentation, and audit-firm advisories on cross-chain governance relay security.
