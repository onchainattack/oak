...
**Attribution:** **responsible disclosure** — multiple audit firms (including OpenZeppelin, Spearbit, and Safe's internal security team) identified the module-boundary issues during pre-deployment and post-deployment security reviews. No attacker exploited the identified surfaces before remediation.
