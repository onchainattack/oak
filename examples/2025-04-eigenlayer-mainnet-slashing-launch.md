...
**Attribution:** **protocol-design** — EigenLayer core development team and EigenDA AVS governance. No adversary; the event is a protocol milestone that activates the slashing surface for all AVS, operators, and LRT holders.
