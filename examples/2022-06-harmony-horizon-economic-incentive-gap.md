...
**Attribution:** **inferred-strong to confirmed.** Elliptic attributed to Lazarus Group / APT38 within days of the event (June 2022) based on laundering-pattern overlap with the Ronin case. FBI confirmed Lazarus Group / APT38 attribution on January 23, 2023, tying the case to the "TraderTraitor" DPRK campaign label.
