...
**Loss:** approximately $42M extracted from GMX V1 GLP pool on Arbitrum.
...
**Attribution:** **pseudonymous-unattributed**; partial recovery via 10% white-hat bounty offer (~$5M returned to GMX recovery multisig per operator post-mortem).
...
- **At-event (rapid pause + bounty offer).** The detection-to-pause latency was approximately 2-4 hours per public timeline; the same-day bounty offer follows the post-Euler-2023 operating norm with a substantially-shorter negotiation window than earlier cases.
- **Post-event (near-100% recovery via white-hat bounty acceptance).** The 10% bounty + no-prosecution commitment produced rapid attacker-acceptance and near-100% recovery; the post-Euler-2023 negotiation pattern is now mature enough that operator-side rapid bounty offers reliably produce rapid attacker-acceptance for the cohort of attackers who are willing to accept negotiated outcomes.
