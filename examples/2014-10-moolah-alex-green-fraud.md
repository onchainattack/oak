...
**Attribution:** **identified-to-convicted** — Ryan Kennedy (operating under the pseudonym "Alex Green") was arrested by UK police in 2015, charged with fraud and money-laundering offences, and convicted. The Moolah case is one of the earliest identified-and-convicted operator-attribution outcomes in the crypto exchange-fraud class.
