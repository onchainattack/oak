...
**Attribution:** **structural / design-level** — trust-model vulnerability rather than attributed attack. Relay operators (Flashbots, bloXroute, Agnostic, Ultrasound, Eden, Aestus, Manifold, Titan) are known entities; no relay operator has publicly been accused of MEV theft.
