...
**OAK Techniques observed:** OAK-T11.001 (Third-Party Signing / Custody Vendor Compromise) — primary; downstream OAK-T7.003 (Cross-Chain Bridge Laundering) via THORChain (see `examples/2025-02-bybit-thorchain-laundering.md`); OAK-T8.001 (Common-Funder Cluster Reuse) for operator-cluster continuity.
