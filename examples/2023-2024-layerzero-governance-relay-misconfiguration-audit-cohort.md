...
**Attribution:** **n/a (audit-finding class)** — no named attacker; the findings were identified and remediated at the pre-deployment audit layer. Attribution is to the audit firms that characterised the class (Trail of Bits, OpenZeppelin, Spearbit) and the protocols that remediated findings pre-exploitation.
