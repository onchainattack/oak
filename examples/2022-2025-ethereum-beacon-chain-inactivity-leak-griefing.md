...
**Attribution:** **unattributed** — the inactivity leak is a protocol-level mechanism, not an attributed attack. The griefing vector is a design-level property of Ethereum's validator economics; no confirmed dollar-extraction-scale griefing incident has been attributed to a specific attacker at v0.1.
