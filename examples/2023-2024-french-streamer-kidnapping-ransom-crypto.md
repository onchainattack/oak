...
**OAK Techniques observed:** none — physical-extortion ransom has no covering Technique. T5.008 (Ransomware Extortion Payment) does not fit: its defining leverage is ransomware deployment — data encryption or threatened leakage — whereas here the leverage is physical violence against a family member. No T7 Technique fits either: the file describes no laundering leg, and its own causal claim is that the \$800K was frozen *because* laundering had not started — the funds were still at Binance, unmixed and unbridged. Candidate T5.x gap: physical-extortion / coercion-based ransom payment ("wrench attack" class). The tracing, freeze, and six arrests are outcome.
