...
**Attribution:** **pseudonymous-cohort** — the operator wallets exhibit funder-graph clustering consistent with a small number of laundering operators. Chainalysis and Elliptic have attributed some of the on-chain patterns to known illicit-cluster continuations (darknet-market vendor wallets, ransomware-affiliate wallets). No named individuals have been publicly attributed at v0.1.
