...
**Attribution:** **inferred-strong (DPRK Lazarus Group per FBI/CISA advisory).** The FBI and CISA issued a joint cybersecurity advisory attributing the CoinEx breach to the DPRK's Lazarus Group (OAK-G01), citing wallet-cluster analysis, laundering-route tracing, and cross-incident attribution continuity with the broader TraderTraitor campaign.
