...
**Attribution:** **confirmed** — see OAK-Gnn line below; the FBI publicly attributed the theft to Lazarus Group / APT38 on 2023-01-23, with corroborating forensic analysis from Elliptic and Chainalysis (multi-source, official attribution).
