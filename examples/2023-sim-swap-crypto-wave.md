...
**OAK Techniques observed:** OAK-T4.007 (Native App Social Phishing) — SIM swap as the account takeover primitive; OAK-T6 (Defense Evasion) — credential reset via telecom compromise.
