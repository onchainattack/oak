...
**Attribution:** **n/a (governance design anti-pattern class).** The class is documented across multiple protocol deployments and audit-firm findings (Trail of Bits, OpenZeppelin, Spearbit). No single operator or protocol is solely associated with the anti-pattern.
