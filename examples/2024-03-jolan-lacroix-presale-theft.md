...
**OAK Techniques observed:** none — presale raise-and-abscond before TGE has no dedicated Technique. T5.005 (Treasury-Management Exit) is the nearest home and has repo precedent for operator exits against a user-deposit pool, but its defining primitive — substantive misuse of legitimately-retained authority, with outflows publicly framed as legitimate expenditure — is absent: Lacroix framed nothing, he absconded. T5.007 is ruled out (requires impersonating a *third party's* brand; TICKER was his own raise). T11.005.x is ruled out (no fake platform, custodian, or UI-fiction layer). Candidate T5.x gap.
