...
**OAK Techniques observed:** OAK-T4.010 (Fake Security Tool Browser Extension Phishing) — extends to fake security tool in official app store; OAK-T6 (Defense Evasion) — seed phrase entry into fake app.
