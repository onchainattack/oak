...
**Attribution:** **pseudonymous (no public attribution)** — no named attacker; the class is documented at the audit-finding level. Attribution is to the audit firms that characterised the class (Trail of Bits, OpenZeppelin, Spearbit) and the protocols that remediated findings pre-exploitation.
