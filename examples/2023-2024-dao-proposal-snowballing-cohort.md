...
**Attribution:** **pseudonymous-cohort** — the proposal-snowballing pattern has been observed across multiple DAOs; in several cases the proposing cohort was attributed at the address-cluster level via T8.001 funding-graph analysis. Named-individual attribution is rare; the pattern is documented at the cohort level.
