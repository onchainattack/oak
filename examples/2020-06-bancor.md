...
**Attribution:** **pseudonymous** The individual who discovered the vulnerability — a security researcher operating within the Bancor ecosystem — extracted the vulnerable-pool funds as a white-hat action to prevent malicious exploitation, then returned the funds to Bancor after the vulnerability was confirmed and patched.
