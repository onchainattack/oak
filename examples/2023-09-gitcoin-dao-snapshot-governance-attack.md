...
**Attribution:** **pseudonymous-cohort** at the Sybil-cluster level; on-chain delegation-graph and Snapshot voting records publicly observable. No named individual attribution. The attacker's Snapshot voting addresses were linked through funder-graph clustering (T8.001).
