...
**Attribution:** **pseudonymous (no public attribution to a named group at v0.1).** Japanese authorities investigated but did not publicly attribute the breach to a specific threat actor.
