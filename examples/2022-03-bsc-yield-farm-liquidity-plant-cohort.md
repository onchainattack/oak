...
**Attribution:** **pseudonymous** — the deployer addresses across the 2022 BSC yield-farm rug cohort form a recurring cluster graph at the funder level; individual operator identities are not publicly attributed.
