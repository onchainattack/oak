...
**Attribution:** **unattributed** — BlockSec's whitehat intervention is publicly documented; the vulnerability disclosure and preemptive blocking were confirmed by both BlockSec and ParaSpace/Parallel Finance. No attacker was identified.
