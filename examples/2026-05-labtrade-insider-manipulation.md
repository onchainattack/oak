...
**Attribution:** **Identified** — Vladimir "Vova" Sadkov (co-founder), Mark (co-founder), and connected insider wallets. On-chain links to RIVER token manipulation ($12M+ received by same insider).
