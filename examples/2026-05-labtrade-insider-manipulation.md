...
**OAK Techniques observed:** **OAK-T3.006** (Insider Multi-Vector Supply Extraction — the canonical anchor; the LABtrade team deployed four simultaneous extraction mechanisms — private OTC/loan deals, unilateral vesting changes, market maker coordination, and CEX deposit dumping — that individually appeared benign but collectively formed a coordinated retail extraction architecture. See [`techniques/T3.006-insider-multi-vector-supply-extraction.md`](../techniques/T3.006-insider-multi-vector-supply-extraction.md)). **OAK-T3.004** (Influencer Amplified Promotion and Dump — secondary; the TGE and public promotion provided the demand-side amplification for the multi-vector extraction architecture).
