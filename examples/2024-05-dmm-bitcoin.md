...
**OAK Techniques observed:** OAK-T11.001 (Third-Party Signing / Custody Vendor Compromise) — primary, via the Ginco wallet-software supply chain; OAK-T15.001 (Social Engineering of Operator Personnel) — LinkedIn fake-coding-test pretext targeted a Ginco employee, the upstream entry vector; OAK-T15.003 (Operator-Endpoint Compromise) — Ginco employee endpoint compromised by the coding-test payload; OAK-T15.002 (Supply-Chain / Vendor-Pipeline Compromise) — vendor-internal-communications and shared-tooling compromise sub-shape used to manipulate a legitimate DMM transaction request; downstream OAK-T7.001 (mixer-routed laundering — Bitcoin CoinJoin) and pending cross-chain laundering Techniques as the attacker cluster rotated proceeds throughout 2024-2025.
