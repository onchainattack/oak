...
- **2026 Q3** — **T12 (NFT-Specific Patterns), announced 2026-08-16**, selected by the rule below: T12 tied for the most `check_targets.py --strict` P1 cells (2021 and 2026) and carried the most TAXONOMY-GAPS candidates without anchors (three) of any Tactic. Scope is **NFT-fi rather than the 2021–2022 marketplace surfaces** — the classic T12 trio (wash trading, counterfeit mint, royalty bypass) describes a market structure that has contracted, while the live attack surface has migrated into protocols that make non-fungible assets behave fungibly. Wave one (2026-08) landed **OAK-T12.006** (NFT-Collateral Lending Manipulation, anchored XCarnival 2022-06 and Omni Protocol 2022-07), **OAK-T12.007** (Mint-Outcome Reroll, anchored Meebits 2021-05), the **T12.008** hybrid-standard forward candidate (anchored Flooring Protocol 2026-06), and closed both P1 year cells. Quarter status as of **2026-09-12**: **Gondi** (2026-03-09, 78 NFTs / ~\$230K) landed as an NFT-fi worked example and says something about the scope choice — the failure was a missing caller check in a convenience wrapper, not NFT-specific valuation, i.e. **NFT-fi inherits DeFi's bugs before it invents its own**. **T12.008 remains at one anchor**: the plausible second candidate (**MINER / ERC-X**, 2024-02) was researched and **rejected** — a self-transfer ordering bug on the fungible ledger that a plain ERC-20 would carry identically, which the Technique's own scope paragraph disqualifies; the determination is recorded on the Technique page so it is not re-run. Still open and **not found in the public record during this sweep**: a qualifying second hybrid-standard anchor (fungible supply diverging from escrowed count, a redemption paying an NFT the position did not entitle, or an identifier resolving differently in authorisation than in accounting), marketplace listing manipulation beyond stale-listing front-running, and RWA-NFT bridge surfaces.
