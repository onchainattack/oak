...
_Generated by `tools/build_backlog.py` on 2026-09-12. Regenerated on every `npm run site:data`._

_Scope: 707 worked examples, 154 Techniques, 20 Threat Actors._
...
- _all active-year cells meet the per-Tactic minimum_
