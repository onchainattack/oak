...
_Generated by `tools/build_backlog.py` on 2026-05-26. Regenerated on every `npm run site:data`._

_Scope: 621 worked examples, 144 Techniques, 19 Threat Actors._
...
- _all candidates are either anchored or already promoted_
