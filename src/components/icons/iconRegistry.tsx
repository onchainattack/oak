// SVG path data for the per-name UI icons. Kept separate from the Icon
// component so the rendering is a thin lookup and the SVG fragments
// live with the design data, not the control flow.
//
// Coordinates assume viewBox="0 0 48 48". Each entry is the inner SVG
// content (a single <g> wrapping the shapes) — the wrapping <svg> +
// <span> is in the component.

import type { ReactNode } from "react";
import type { IconName } from "../../types";

export const ICON_GROUPS: Record<IconName, ReactNode> = {
  matrix: (
    <g>
