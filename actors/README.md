...
- [`OAK-G18-karakurt.md`](./OAK-G18-karakurt.md) — Karakurt / Karakurt Lair; Russian-language **extortion-only data-theft** operation with no encryption stage; emerged mid-2021 as a Conti side channel; cryptocurrency-denominated ransom payments operational from inception; included for the operating model that separates data-theft extortion from ransomware proper.
- [`OAK-G19-darkside.md`](./OAK-G19-darkside.md) — DarkSide RaaS (Aug 2020 – May 2021) and its BlackMatter rebrand (Jul – Nov 2021); **confirmed** via FBI attribution of Colonial Pipeline + CISA AA21-131A + the DOJ seizure warrant that recovered 63.7 of 75 BTC by private-key recovery (Jun 2021) — the seizure precedent that shaped U.S. ransomware policy; **closed cluster**, read as a historical reference.
- [`OAK-G20-teampcp.md`](./OAK-G20-teampcp.md) — TeamPCP / UNC6780 (Google TIG), also DeadCatx3, PCPcat, ShellForce; cross-ecosystem supply-chain worm operator behind the Shai-Hulud (Sep/Nov 2025) and Mini Shai-Hulud (Apr/May 2026) campaigns; **inferred-strong, self-claimed** — no individual named, tracked independently by JFrog, Snyk, Orca, Tenable, StepSecurity and CSA; first documented self-propagating supply-chain worm to cross ecosystem boundaries autonomously (npm, PyPI, GitHub Actions, VS Code extensions, Docker Hub, Kubernetes); TanStack 2026-05-11 (42 packages, 84 versions carrying valid SLSA L3 provenance) + Nx Console 2026-05-18 (~3,800 private repos downstream); worm source released under MIT on 2026-05-12, which breaks payload-resemblance attribution for everything after it. **The first OAK Group whose product is access rather than money.**
