...
- [`examples/2026-04-kelpdai-rseth-bridge-layerzero-compromise.md`](../examples/2026-04-kelpdai-rseth-bridge-layerzero-compromise.md) — \~\$292M (116,500 rsETH) from the KelpDAO rsETH bridge, via **RPC poisoning beneath a single LayerZero DVN** rather than any key theft. Initial access 2026-03-06 by social engineering of a LayerZero Labs developer and session-key harvest (T15.001 → T15.004), six weeks before the funds moved; canonical **OAK-T10.002.001** sub-shape (c) case. Attributed to **TraderTraitor / UNC4899** by Mandiant, CrowdStrike and zeroShadow, and named in LayerZero Labs' own incident report. **Added 2026-09-16**: the incident was previously recorded in OAK as `pseudonymous` and unlinked to this profile.
